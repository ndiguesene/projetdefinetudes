...
const DashboardGridsterConfig: GridsterConfig = {
  ...
  minCols: 4, // minimum amount of columns in the grid
  maxCols: 8, // maximum amount of columns in the grid
  minRows: 3, // minimum amount of rows in the grid
  maxRows: 5, // maximum amount of rows in the grid
  defaultItemCols: 4, // default width of an item in columns
  defaultItemRows: 3, // default height of an item in rows
  maxItemCols: 5, // max item number of cols
